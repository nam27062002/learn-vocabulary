...
def i18n_compatible_translations(request):
    ...
    legacy_translations = {
        'en': {
            ...
            'manage_words_excluded': 'Manage words excluded from your study sessions',
            'total_blacklisted': 'Total Blacklisted',
            'filtered_results': 'Filtered Results',
            'selected': 'Selected',
            'page': 'Page',
            'search_words_decks': 'Search words, decks, or definitions...',
            'select_all': 'Select All',
            'clear': 'Clear',
            ...
            'actions': 'Actions',
            'no_blacklisted_words_found': 'No Blacklisted Words Found',
            'no_blacklisted_words_message': 'You haven\'t blacklisted any words yet, or no words match your current search.',
            'start_studying': 'Start Studying',
            'browse_decks': 'Browse Decks',
            'showing_words': 'Showing {start}-{end} of {total} words',
            ...
            'loading_blacklisted_words': 'Loading blacklisted words...',
            'searching_for': 'Searching for "{query}" - {count} results found',
            'words_selected': '{count} word{plural} selected',
            'all_words_selected': 'All {count} words selected',
            'successfully_removed_words': 'Successfully removed {count} word{plural} from blacklist',
            'word_removed_from_blacklist': 'Word removed from blacklist',
            'error_removing_word': 'Error removing word: {error}',
            'error_removing_items': 'Error removing items: {error}',
            'error_selecting_all_items': 'Error selecting all items',
            'error_loading_blacklisted_words': 'Error loading blacklisted words. Please try again.',
            'removing': 'Removing...',
        ...
        'vi': {
            ...
            'no_notes': 'Chưa có ghi chú nào. Hãy viết ghi chú đầu tiên!',
            'confirm_delete': 'Bạn có chắc chắn muốn xóa ghi chú này không?',
            'save_note': 'Lưu ghi chú',
            'save_changes': 'Lưu thay đổi',
            'title_placeholder': 'Nhập tiêu đề ghi chú...',
            'content_placeholder': 'Viết nội dung ghi chú ở đây...',
            'note_detail': 'Chi tiết ghi chú',
            'back_to_notes': 'Quay lại danh sách ghi chú',
            'removing': 'Đang xóa...',
        }
    }
